...
public interface ILlmOpinionRepository
{
    ...
    Task<IReadOnlyList<LlmOpinionRecord>> GetPendingRecommendationsAsync(CancellationToken cancellationToken = default);
    ...
    Task UpdateOpinionOutcomeAsync(long opinionId, decimal outcomePercent, string outcomeReason, DateTime outcomeAt, CancellationToken cancellationToken = default);
}
