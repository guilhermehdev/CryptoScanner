...
public interface ISignalRepository
{
    ...
    Task InsertSignalAsync(string symbol, decimal price, decimal score, string signal, CancellationToken cancellationToken = default);
    Task UpdateSignalResultAsync(int id, decimal outcomePrice, decimal outcomePercent, CancellationToken cancellationToken = default);
